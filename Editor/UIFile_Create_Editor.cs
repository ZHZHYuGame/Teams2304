...
public class UIFile_Create_Editor : EditorWindow
{
    ...
    private void OnGUI()
    {
        ...
        {
            //XXXConfig.lua
            string config_Code_Path = $"{Application.dataPath}/Scripts/Lua/UI/{ui_Name}/{ui_Name}Config.lua";
            ...
            //XXXModel.lua
            string model_Code_Path = $"{Application.dataPath}/Scripts/Lua/UI/{ui_Name}/Model/{ui_Name}Model.lua";
            ...
            //XXXView.lua
            string view_Code_Path = $"{Application.dataPath}/Scripts/Lua/UI/{ui_Name}/View/{ui_Name}View.lua";
            ...
            //XXXControll.lua
            string controll_Code_Path = $"{Application.dataPath}/Scripts/Lua/UI/{ui_Name}/Controll/{ui_Name}Controll.lua";
            ...
            string component_Code_Path = $"{Application.dataPath}/Scripts/Lua/UI/{ui_Name}/Component";
