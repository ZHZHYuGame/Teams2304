...
public class NetManager:Singleton<NetManager>
{
    ...
    public void Start()
    {
        ...
        Console.WriteLine("BWOnline服务器启动成功");
        //监听客户端连接的触发
    ...
    private void AcceptHandle(IAsyncResult ar)
    {
        ...
        clientsList.Add(c);
        //C_To_S_Player_Id_Msg s_Msg = new C_To_S_Player_Id_Msg();
        //s_Msg.Id = PlayerId;
        //SendMessage(NetID.S_To_C_PlayerId, s_Msg.ToByteArray(), c.st);
    ...
    public Client GetClient(Socket st)
    {
        Client c = null;
...
public class Client
{
    ...
    public string name;
    public float money;
    //public List<GoodsData> shopDatas;
    //public List<CBagData> bagDatas;
    public int bagitemnum = 10;
}
