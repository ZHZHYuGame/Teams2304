...
public class AssetBundlePackaggeMer : Editor
{
    ...
    public static void AssetBundleFiltrate()
    {
        ...
        foreach (string fp in allFiles)
        {
            ...
            //string abExt=Path.GetExtension(packPath);
            //switch (abExt)
            //{
            //    case ".prefab":
    ...
    {
        File.WriteAllText($"{Application.dataPath}/Resources/ABOutFiles/AssetMainfast.txt",text);
    }
    /// <summary>
    /// 转化一个资源的MD5码
    /// </summary>
    ...
    {
        File.WriteAllText($"{Application.dataPath}/Resources/ABOutFiles/Version.txt",Application.version);
    }
}
